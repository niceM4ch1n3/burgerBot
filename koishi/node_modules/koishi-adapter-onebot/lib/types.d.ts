...
export declare type GroupRole = 'member' | 'admin' | 'owner';
export declare type HonorType = 'talkative' | 'performer' | 'legend' | 'strong_newbie' | 'emotion';
...
export declare type DataDirectory = 'image' | 'record' | 'show' | 'bface';
